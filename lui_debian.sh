#!/bin/bash
# LUI for Debian - Version 2.1.6b
#
# Description: This script searches and organizes information about users on Debian systems. It is written to make administration easier and for better transparency.
#
# Note: this program has been tested on Debian 7 and Debian 8.
#
# Author: s1x
