#!/bin/bash
# LUI for RedHat Enterprise Linux - Version 2.1.7b
#
...
#
# Note: this program has been tested on RedHat 6, RedHat 7, CentOS 7 and Fedora 20.
#
# Author: s1x
...
function help {
  echo '''
     Linux User Info v2.1.7b
        ...
        You can user multiple arguments too, eg. "./lui_rhl.sh -l -u"
'''
}
...
function user_info {
  ...
  pass=$(passwd -S $OPTARG | awk {'print $8,$9,$10,$11'} | sed -e 's/(//' -e 's/)//')
